...
public class WebMappingConstant {
	 ...
	 */
	public static final String SUCCESS_DELETE_BY_ID = "!succes de supression";
	 ...
	 */
	public static final String FAIL_DELETE_BY_ID = "!erreur de supression";
